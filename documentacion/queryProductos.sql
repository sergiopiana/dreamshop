SELECT 
P.IdProducto as id ,P.Nombre as nombre, P.Observaciones as descripcion, P.FotoPath as imagen, R.Nombre as rubro, S.Nombre as subrubro, round(PR.Precio * cotizacion,0) as precio,  P.BajaStock as stock
FROM
	productos P
