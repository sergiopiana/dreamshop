...
!(function(a, b) {
  ...
  (n.fn = n.prototype = {
    ...
    n.extend({
      ...
      isPlainObject(a) {
        let b;
        if (n.type(a) !== 'object' || a.nodeType || n.isWindow(a)) return !1;
        if (
          a.constructor &&
  ...
  const t = (function(a) {
    ...
    return (
      ...
      ia(a => a.getAttribute('disabled') == null) ||
        ja(K, (a, b, c) => {
          let d;
          return c
            ? void 0
  ...
  function z(a, b, c) {
    ...
    return n.grep(a, a => h.call(b, a) > -1 !== c);
  }
    ...
    n.fn.extend({
      data(a, b) {
        ...
        if (void 0 === a) {
          if (
            this.length &&
            ((e = O.get(f)), f.nodeType === 1 && !N.get(f, 'hasDataAttrs'))
          ) {
            c = g.length;
            while (c--)
              g[c] &&
  ...
  function W(a, b, c, d) {
    let e,
      ...
      k = (n.cssNumber[b] || (j !== 'px' && +i)) && T.exec(n.css(a, b));
    if (k && k[3] !== j) {
      (j = j || k[3]), (c = c || []), (k = +i || 1);
  ...
  function ca(a, b, c, d, e) {
    for (
      ...
      if (((f = a[o]), f || f === 0))
        if (n.type(f) === 'object') n.merge(m, f.nodeType ? [f] : f);
        else if (ba.test(f)) {
        ...
        c.handler && ((f = c), (c = f.handler), (e = f.selector)),
          ...
          (g = r.handle) ||
            (g = r.handle = function(b) {
              return typeof n !== 'undefined' && n.event.triggered !== b.type
  ...
  let ka = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
    ...
    n.fn.extend({
      ...
      empty() {
        for (var a, b = 0; (a = this[b]) != null; b++)
          a.nodeType === 1 && (n.cleanData(_(a, !1)), (a.textContent = ''));
        return this;
      },
      clone(a, b) {
        return (
  ...
  n.extend({
    ...
    n.each(['height', 'width'], (a, b) => {
      n.cssHooks[b] = {
        get(a, c, d) {
          return c
            ? Ha.test(n.css(a, 'display')) && a.offsetWidth === 0
              ? Da(a, Ia, () => Pa(a, b, d))
              : Pa(a, b, d)
            : void 0;
        },
        set(a, c, d) {
          let e,
            ...
            g =
              d &&
              Oa(a, b, d, n.css(a, 'boxSizing', !1, f) === 'border-box', f);
          return (
            g &&
              (e = T.exec(c)) &&
              (e[3] || 'px') !== 'px' &&
    ...
    (n.cssHooks.marginRight = Ga(
      l.reliableMarginRight,
      (a, b) =>
        b ? Da(a, { display: 'inline-block' }, Fa, [a, 'marginRight']) : void 0,
    )),
  ...
  n.fn.extend({
    addClass(a) {
      ...
      if (typeof a === 'string' && a) {
        ...
        while ((c = this[i++]))
          if (
            ((e = fb(c)), (d = c.nodeType === 1 && ` ${e} `.replace(eb, ' ')))
          ) {
            g = 0;
      ...
      return typeof b === 'boolean' && c === 'string'
        ...
        : n.isFunction(a)
          ...
          : this.each(function() {
              ...
              } else (void 0 !== a && c !== 'boolean') || ((b = fb(this)), b && N.set(this, '__className__', b), this.setAttribute && this.setAttribute('class', b || a === !1 ? '' : N.get(this, '__className__') || ''));
            });
    },
    hasClass(a) {
      let b,
  ...
  n.extend({
    ...
    ajax(b, c) {
      ...
      if ((e = xb(tb, m, c, x))) {
        if (((x.readyState = 1), k && p.trigger('ajaxSend', [x, m]), v === 2))
          return x;
        m.async &&
          m.timeout > 0 &&
          (i = a.setTimeout(() => {
  ...
  (n.fn.load = function(a, b, c) {
    if (typeof a !== 'string' && Lb) return Lb.apply(this, arguments);
    let d,
      e,
      f,
      g = this,
    ...
    n.fn.extend({
      ...
      offsetParent() {
        return this.map(function() {
          ...
          while (a && n.css(a, 'position') === 'static') a = a.offsetParent;
          return a || Ea;
        });
      },
    }),
